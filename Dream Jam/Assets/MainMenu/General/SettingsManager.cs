...
public class SettingsManager : MonoBehaviour
{
    ...
    {
        FindObjectOfType<LanguageChanger>().currentLanguage = lang;
        FindObjectOfType<LanguageChanger>().ChangeLanguagePrefab();
        FindObjectOfType<DialogueManagment>().GetDialogue();
        if (lang == "English")
        {
            TextMeshProUGUI[] TMP;
            Text[] texts;
    ...
    void Start()
    {
        ...
        //List<string> languages = FindObjectOfType<LanguageChanger>().languages.ToList();
